...
```
(1)  bash step1_check_PMID_status.sh    ## Used to detect the analysis status of various literature under the demo_workpath, and save the analysis status results to DB-PMID_status.csv 
...
(4)  bash step4_pdf2txt_a04.sh    ## Parse the PDF of the literature under the demo_workpath into txt format
